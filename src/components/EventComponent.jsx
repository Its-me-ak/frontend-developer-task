                    ...
                    <div className='lg:w-2/5 w-full'>
                        <div className="content-wrapper px-7 lg:mt-0 mt-10">
                            ...
                            <div className='flex mt-4 items-center lg:justify-start justify-center'>
                                <img src="./img/artist1.png" className='rounded-md object-cover lg:h-28 md:h-52 h-28' alt="" />
                                <img src="./img/artist2.png" className='rounded-md object-cover lg:h-36 md:h-64 h-36' alt="" />
                                <img src="./img/artist3.png" className='rounded-md object-cover lg:h-28 md:h-52 h-28' alt="" />
                            </div>
